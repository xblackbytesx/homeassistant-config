...
mkdir -p www/custom-lovelace/mqtt-networkmap
wget https://github.com/azuwis/zigbee2mqtt-networkmap/releases/download/v0.5.0/zigbee2mqtt-networkmap.js -O www/custom-lovelace/mqtt-networkmap
